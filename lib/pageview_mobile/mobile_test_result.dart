                          ...
                          builder: (context) {
                            if (widget.cvaivalue < 5.0 && widget.crvalue < 90) {
                              return ResultCard(
                                ...
                                result_detail:
                                    '만약 아이가 이 수치에 배당 된다면 안심하셔도 됩니다.  낮에 아이와 Tummy time를(엎어 놓기 놀이) 자주해 주세요. 엎어 놓기 놀이는 아이의 행동 발달에도 도움이 되고 두상 비대칭 예방도 되어 일석이조의 효과를 얻을수 있습니다.',
                              ...
                              return ResultCard(
                                ...
                                result_detail:
                                    '이 수치에 해당 된다면 이마 비대칭도 육안적으로 보이고 심하면 양 귀 위치의 관계에도 차이가 있습니다. 이는 어릴 때 바르게 잡아주지 않으면 심한 비대칭이 발생하고 더 큰 건강 문제도 초래 할 수 있으므로 예방 및 치료가 필요합니다. 빠른 시일 내에 사두증 전문 병원을 방문 하여 검사를 받아 보세요!',
                              ...
                              return ResultCard(
                                ...
                                result_detail:
                                    '이단계는 귀의 위치뿐만 아니라 정면에서 눈썹 및 눈의 위치도 다르게 보입니다. 이 경우에는 두개의 비대칭이 심하여 추후 턱 관절 문제와 더불어 목 사경까지 이르를 수 있어서 상당한 건강 문제를 초래할 수도 있습니다. 이 단계는 자연적 치료가 어려우니 적극적으로 치료를 해주세요. 어떻게 시작할지 모르실 경우는 반드시 병원을 방문하거나 전문가에게 도움을 요청해야합니다.',
